...
@section('card-title', 'Edit RT/RW')

@section('form')
    <form id="contactForm" action="{{route('association.update',["association" => $association->id])}}" method="post">
        @csrf
        @method('put')
        <div class="mb-3">
            <label class="form-label" for="nama">Nama</label>
            <input class="form-control" id="nama" name="name" value="{{$association->name}}" type="text" placeholder="Nama" data-sb-validations="required" />
            <div class="invalid-feedback" data-sb-feedback="nama:required">Nama is required.</div>
        </div>
        <div class="mb-3">
            <label class="form-label d-block">Jabatan</label>
            @if($association->position == 'RT')
                <div class="form-check form-check-inline">
                    <input class="form-check-input" id="rt" value="RT" type="radio" name="position" data-sb-validations="required" checked />
            ...
            @else
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" id="rw" value="RW" type="radio" name="position" data-sb-validations="required" checked/>
                    <label class="form-check-label" for="rw">RW</label>
                </div>
            @endif
        ...
        <div class="mb-3">
            ...
            <input class="form-control" id="nomerRtRw" value="{{$association->association_number}}" name="association_number" type="text" placeholder="Nomer RT/RW" data-sb-validations="required" />
            <div class="invalid-feedback" data-sb-feedback="nomerRtRw:required">Nomer RT/RW is required.</div>
        </div>
        <div class="mb-3">
            <label class="form-label" for="alamat">Alamat</label>
            <input class="form-control" id="alamat" type="text" value="{{$association->address}}" name="address" placeholder="Alamat" data-sb-validations="required" />
