...
@section('form')
    <form id="contactForm" action="{{route('level.store')}}" method="post">
        @csrf
        <div class="mb-3">
            <label class="form-label" for="level">Level</label>
            <input class="form-control" id="level" type="number" name="level" placeholder="Level" data-sb-validations="required" />
            <div class="invalid-feedback" data-sb-feedback="level:required">Level is required.</div>
        </div>
        <div class="mb-3">
            <label class="form-label" for="jabatan">Jabatan</label>
            <input class="form-control" id="jabatan" type="text" name="title" placeholder="Jabatan" data-sb-validations="required" />
